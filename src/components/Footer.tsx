    ...
    <footer className="border-t border-neutral-800 py-8">
      <div className="container mx-auto px-4 text-center text-stone-400">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <a href="https://x.com/CrypO8ne" className="hover:text-white transition-colors">Twitter</a>
          <a href="https://github.com/Sriyush" className="hover:text-white transition-colors">GitHub</a>
